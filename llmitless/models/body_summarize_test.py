...
T = TypeVar("T", bound="BodySummarizeTest")


@_attrs_define
class BodySummarizeTest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_summarize_test.additional_properties = d
        return body_summarize_test
